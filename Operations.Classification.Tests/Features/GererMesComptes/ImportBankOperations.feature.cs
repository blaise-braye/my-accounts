...
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Execute two successive Imports", ((string[])(null)));
#line 43
...
#line 46
            testRunner.Given(
                "I import the qif data on account \'Automated Test Account\'",
                "!Type:Bank\r\nD09/28/2016\r\nT0.01\r\nMSome Memo\r\nN2017-0148\r\n^",
                ((TechTalk.SpecFlow.Table)(null)),
                "Given ");
#line 55
            testRunner.And(
                "I wait that last imported qifdata in account \'Automated Test Account\' is availabl" +
                "e in export",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "And ");
...
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Export imported operations", ((string[])(null)));
#line 20
            this.ScenarioSetup(scenarioInfo);
#line 4
            this.FeatureBackground();
...
#line 36
            testRunner.When(
                "I export the qif data from account \'Automated Test Account\', between \'2016-04-11T" +
                "00:00:00\' and \'2016-11-05T00:00:00\'",
                ((string)(null)),
                ((TechTalk.SpecFlow.Table)(null)),
                "When ");
#line hidden
...
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Identify delta between imported qif data and new available qif data", ((string[])(null)));
#line 83
            this.ScenarioSetup(scenarioInfo);
#line 4
            this.FeatureBackground();
...
#line 103
            testRunner.Given(
                "I have an update of the qif data file to import",
                "!Type:Bank\r\nD09/27/2013\r\nT0.01\r\nMUnchanged\r\n^\r\n!Type:Bank\r\nD09/29/2013\r\nT0.02\r\nMU" +
                "pdated Memo\r\n^\r\n!Type:Bank\r\nD01/11/2014\r\nT0.01\r\nMAdded Memo\r\n^",
                ((TechTalk.SpecFlow.Table)(null)),
                "Given ");
...
#line 124
            testRunner.Then(
                "dry run import available qif data to account \'Automated Test Account\' produces th" +
                "e following delta report",
                ((string)(null)),
                table3,
                "Then ");
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Import an operation", ((string[])(null)));
#line 8
            this.ScenarioSetup(scenarioInfo);
#line 4
            this.FeatureBackground();
