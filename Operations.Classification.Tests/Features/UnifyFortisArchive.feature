...
Scenario: parse 'PermanentOrder'
	Given I have read the following account operations from source of kind FortisCsvArchive
	| OperationId | Note                                                                                                                                                                                                                                    |
...
Scenario: parse 'CartPayment'
	...
	| Ref1        | C'KI LE ROI SPRL | WOLUWE SA | CartPayment |
	| Ref2        | COLRUYT ET       | ETTERBE   | CartPayment |
...
Scenario: parse 'Withdrawal'	
	...
	| Ref1        |            | BRAINE L'    | Withdrawal  | BELFIUS37104704  |
	| Ref2        |            | JOURDAN      | Withdrawal  | BELFIUS35792103  |
	| Ref3        |            | FRANCORCH    | Withdrawal  | AXA SCHMITZ      |
	| Ref4        |            | CHAUDFONT    | Withdrawal  | CHAUDFONTAINE    |
	| Ref5        |            | BRAINE AL    | Withdrawal  | BRAINE L ALLEUD  |
